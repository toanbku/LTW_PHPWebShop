...
elseif ($action == "exist"){
	...
	echo '<strong>Title!</strong> Alert body ...';
	echo '</div>';
				...
				<div class="p-l-25 p-r-30 p-lr-0-lg">
					<div class="wrap-slick3 flex-sb flex-w">
						...
						<div class="slick3 gallery-lb">
							<?php
									// set product id
									$product_image->product_id = $id_product;
					...
					<div class="tab-pane fade show active" id="description" role="tabpanel">
						<div class="how-pos2 p-lr-15-md">
							<p class="stext-102 cl6">
								Nunc eget facilisis nisl. Vestibulum sed suscipit sapien, vel porta ligula. Nulla facilisi. Maecenas efficitur
								magna id laoreet tempus. Praesent dignissim, lectus at venenatis aliquam, purus ante feugiat lectus, at
								facilisis lorem mauris a dui. Nam dolor velit, bibendum at euismod at, feugiat vitae nisl. Etiam aliquet neque
								ipsum
							</p>
						</div>
					</div>
