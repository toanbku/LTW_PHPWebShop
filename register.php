...
<body class="animsition">
	...
	<header>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<a href="#" class="dis-block icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti" data-notify="4">
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.html"><img src="images/icons/HCMUT_official_logo.png" alt="IMG-LOGO"></a>
			</div>
	...
	<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md" style="margin: 0 auto;">
					<form action="s-register.php" method="post">
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="firstName" placeholder="firstName" onchange="checkLength(firstName, firstNameError)">
						</div>
						<p id="firstNameError" class="error"></p>

						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="lastName" placeholder="lastName" onchange="checkLength(lastName, lastNameError)">			
						</div>
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="userName" placeholder="userName" onchange="checkLength(userName, userNameError)">			
						</div>
						...
						<a href="register.php" style="text-decoration: none; margin-left: 40%;">Register</a> | 
...
<!--===============================================================================================-->	
	...
	<script type="text/javascript">
		function checkLength(id, idError){			
			var temp = id.value.length;	
			if (temp < 2 || temp > 30) {
				idError.innerHTML = "Error: Length from 2 to 30 charater!";
			}
				else {
					idError.innerHTML = "";
				}
		}
		function checkEmail(id, idError){
			var re = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
			if (!re.test(String(id.value).toLowerCase())) {
				idError.innerHTML = "Error: Email invalid!";
			}
				else {
					idError.innerHTML = "";
				}
		}
		function checkRepeat(id1, id2, idError){
			var value1 = id1.value;
			var value2 = id2.value;
			if (value1 != value2) {
				idError.innerHTML = "Error: password not same!";
			}
				else {
					idError.innerHTML = "";
				}
		...
		// 	}
		// 		else window.alert("Value input invalid!");
		// }
	</script>
