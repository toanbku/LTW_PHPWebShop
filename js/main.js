...
(function ($) {
    ...
    $filter.each(function () {
        $filter.on('click', 'button', function () {
            ...
            $topeContainer.isotope({filter: filterValue});  //sort magical layouts
        });
    ...
    $('.btn-num-product-down').on('click', function(){
        ...
        if(numProduct > 0) {
            ...
            var total= $(this).parent().parent().next().text();
    ...
    $('.btn-update-cart').on('click', function(){
        console.log($(this).parent().parent().find("column-5").text());
        //continue
    });
    /*==================================================================
    [ Rating ]*/
